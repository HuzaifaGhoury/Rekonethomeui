      ...
      <div key={post.id}>
        ...
        <div className='ml-4 mt-3 '>
          <div className='flex gap-7'>
            ...
            <FaRegCommentDots className='text-2xl text-gray-300 mt-1 cursor-pointer' onClick={toggleCommentSection} />
...
{isCommentSectionVisible && (
  <div className="transition-all duration-300 absolute top-0 right-0 bg-white border border-gray-300" style={{ width: 'calc(30% - 50px)' }}>
    <div className="flex justify-between  p-4">
      <div>Messages</div>
      <div><CloseOutlined className="text-xl cursor-pointer" onClick={toggleCommentSection} /></div>
    </div>
    <Commentcontent />
  </div>
)}
