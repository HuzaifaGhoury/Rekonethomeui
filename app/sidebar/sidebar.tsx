...
const Sidebar = () => {
    ...
    return (
        <div className="flex">
            ...
            <div className={`fixed top-0 left-0 w-60 h-screen bg-gray-100 z-50 md:hidden ${isDrawerOpen ? 'block' : 'hidden'}`}>
            ...
            <div className={`w-60 h-auto bg-gray-100 hidden md:block`}>
                <div>
                    <Image src={logo} alt='logo' className='ml-9' />
                </div>
                <div className='flex font-inter font-bold text-sm text-slate-900'>
